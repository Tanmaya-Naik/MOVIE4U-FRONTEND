...
const MovieCard=({movie}) => {
    ...
    return (
        ...
        className="block w-48 md:w-52 rounded-lg overflow-hidden shadow-md
         transform transition-transform duration-200 hover:scale-105 no-underline">
            ...
            className="absolute bottom-0 left-0 w-full h-2/5
             ...
             <div className="absolute bottom-0 left-0 w-full px-3 pb-3 pt-8 text-white
             opacity-0 hover:opacity-100 transition-opacity duration-300">
                <h3 className="text-sm font-semibold text-yellow-300 leading-tight line-clamp-2">{title}</h3>
